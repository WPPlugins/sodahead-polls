...
echo "var customize = '" .
  preg_replace('/[^A-Za-z]/', '', $_GET['customize']) . "';";
echo "var widget_select_id = '" .
  preg_replace('/[^A-Za-z0-9_-]/', '', $_GET['widget_select_id']) . "';";
?>
...
jQuery.ajax({
  url:'http://<?php echo $sodahead_url; ?>/wpapi/question/crossdomain_ask/',
